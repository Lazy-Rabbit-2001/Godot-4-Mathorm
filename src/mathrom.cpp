...
void Ellipse::_bind_methods()
{
    ...
    ClassDB::add_property("Ellipse", PropertyInfo(Variant::VECTOR2, "center"), "set_center", "get_center");
    ...
    ClassDB::add_property("Ellipse", PropertyInfo(Variant::VECTOR2, "amplitude"), "set_amplitude", "get_amplitude");
    ...
    ClassDB::add_property("Ellipse", PropertyInfo(Variant::VECTOR2, "rotation"), "set_rotation", "get_rotation");
